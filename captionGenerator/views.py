...
def predict_caption(request):
    if request.method == 'POST':
        ...
        # save the image to a temporary file
        temp_img_path = os.path.join(settings.BASE_DIR, 'F:\Saafi\Image-Caption-\captionGenerator\static', 'temp_img.png')
        ...
        predict_script_path = os.path.join(settings.BASE_DIR, 'ImageCaption', 'src', 'predict.py')
